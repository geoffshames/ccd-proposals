...
export const keyveatz: ProjectData = {
    ...
    tiers: [
      {
        ...
        footerNote:
          "The minimum that still clears YOUNG POSSE pace. Heavy on Influencer + Fan Pages + Clipping/Edits + Twitter — the K-pop core. Trades Programmatic and AR layers for compounding social volume.",
      },
      {
        ...
        includes: [
          ...
          "Fan Pages — $30K ($10K/mo × 3 owned channels for the core campaign window)",
          "YouTube Advertising — $18K (In-Stream + In-Feed + Engagement)",
          "TikTok Advertising — $14K (Spark Ads + In-Feed + TopView)",
      ...
      },
      {
        ...
        includes: [
          "Fan Pages — $35K ($10K/mo × 3 owned channels with extended runway through post-release sustain)",
          "Influencer Campaign — $35K (highest-volume paid creator program on TikTok + Reels, mix of Korean + global tiers via LV8)",
          "YouTube Advertising — $22K",
          "Twitter / X Advertising — $18K (Stan Twitter activation, hashtag campaigns, Spark Ads, takeover units, coordinated drops)",
          "TikTok Advertising — $14K",
          "Clipping Support / Edits — $11K (highest-tier scaled bulk UGC distribution + fancam edit seeding)",
          "Meta Advertising — $10K",
  ...
  timeline: [
    ...
    },
    {
      ...
      status: "upcoming" as const,
      tasks: [
        "EP 2 release day — full paid media surge across YT, Meta, TikTok, Twitter, Programmatic; Fan Pages + Clipping flow at peak; Stan Twitter activation peaks",
  ...
  deliverables: [
    {
      ...
      icon: "▶",
      items: [
        { name: "YouTube Advertising", quantity: "$18K", description: "In-Stream (TrueView) for low-cost MV view velocity, In-Feed (Discovery) for channel growth, Engagement campaigns for K-pop and similar-artist conquesting audiences" },
        ...
        { name: "TikTok Advertising", quantity: "$14K", description: "Spark Ads boosting top-performing organic and influencer content; In-Feed creative; TopView units flighted to release day" },
  ...
  quote: {
    ...
    lineItems: [
      ...
      { name: "YouTube Advertising", description: "In-Stream (TrueView) + In-Feed (Discovery) + Engagement campaigns flighted around the EP 2 release window across all 14 regional markets", price: 18000 },
      { name: "TikTok Advertising", description: "Spark Ads + In-Feed + TopView units flighted to the release day window", price: 14000 },
  ...
  cta: {
    ...
    body: "KEYVEATZ has the rarest asset in 5th-gen K-pop right now — institutional hip-hop credibility from the labels that broke Korean rap globally. The only thing standing between this moment and a Top-3 5th-gen girl group outcome is the per-channel paid + Influencer + Twitter + Clipping/Edits + Fan Pages + chart-force stack that converts the credibility into compounding monthly listeners and chart positions. Crowd Control Digital has built and run this architecture across multiple major K-pop release cycles. Three tiers. One drop. June 29.",
    email: "geoff@crowdcontroldigital.com",
  },
