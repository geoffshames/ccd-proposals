  ...
  audience: {
    ...
    platforms: [
      ...
      },
      {
        name: "Spotify",
        description:
          "Where the campaign is judged. Monthly listeners, save rate, and editorial playlist position (NEW MUSIC FRIDAY KOREA, RADAR KOREA, EQUAL) are the lagging indicators every other channel feeds into.",
      },
    ],
    quotes: [
