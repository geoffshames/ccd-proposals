...
export const armenta: ProjectData = {
  ...
  quote: {
    ...
    currency: "USD",
    lineItems: [
      { name: "Paid Media Management", description: "Full-funnel management of YouTube In-Stream/Discovery, Meta, and TikTok Spark Ads — strategy, build, optimization, and reporting. Ad spend is billed separately at a 15% management fee (see media budget below).", price: 0, priceLabel: "Incl.", recurring: true },
      { name: "Corridos Creator Campaign", description: "CCD's proven PRC creator playbook — creator sourcing, contracting, content review, and distribution across US Hispanic + Mexico. Creator fees billed separately at a 15% management rate.", price: 0, priceLabel: "Incl.", recurring: true },
      { name: "Content Engine", description: "Weekly Reels/TikTok cutdowns produced from album and collab assets to feed paid media and compound organic reach.", price: 0, priceLabel: "Incl.", recurring: true },
      { name: "Release Marketing + Reporting", description: "Coordinated single/collab launch surges, playlist/editorial support, the artist-sovereign capture layer, live pacing dashboard, and bi-weekly reviews — all included in the retainer.", price: 7500, recurring: true },
    ],
    subtotal: 7500,
    discount: { label: "", percentage: 0, amount: 0 },
    mediaBudget: {
      label: "Recommended Paid Media Budget",
      amount: 25000,
      note: "DRAFT recommendation. Ad spend across YouTube, Meta, and TikTok — billed to the platforms directly, plus a 15% CCD management fee. Creator fees billed at the same 15% rate. Budget is adjustable up or down with the team.",
    },
    total: 22500,
    paymentSchedule: [
      { milestone: "Month 1 — Creative + Content Retainer", percentage: 33, amount: 7500, due: "Upon approval" },
      { milestone: "Month 2 — Creative + Content Retainer", percentage: 33, amount: 7500, due: "August 1, 2026" },
      { milestone: "Month 3 — Creative + Content Retainer", percentage: 34, amount: 7500, due: "September 1, 2026" },
    ],
    paymentTerms:
      "DRAFT pricing — not yet approved; built to be adjusted with the team. Retainer covers creative, content, and creator management. Paid media budget ($25K/mo recommended) is billed to platforms directly; CCD's 15% management fee applies to media spend and creator fees, invoiced monthly. 7 days from invoice.",
    paymentLink: "#approve",
  },
