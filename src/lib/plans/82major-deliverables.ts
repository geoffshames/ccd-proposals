...
export const eightyTwoMajorDeliverables: StrategyPlanData = {
  ...
  sections: [
    ...
    // ===================================================================
    {
      ...
      intro: "What CCD needs access to before paid spend goes live. Check items off as they are granted; most take minutes on the Kakao side and the full list can clear in a day. Spend runs from CCD's own ad accounts.",
