...
export const eightyTwoMajorDeliverables: StrategyPlanData = {
  ...
  sections: [
    ...
    // ===================================================================
    {
      ...
      intro: "Twelve requested assets across four groups. Each card carries the hook and CTA logic plus playable peer references.",
    ...
    // ===================================================================
    {
      ...
      subBlocks: [
        ...
        {
          label: "B",
          title: "Volume of the full request",
          objective: "The full request adds up to roughly 35-45 final files: 12 concepts, two ratios each (9:16 + 1:1), 2-3 hook variants on heroes.",
    ...
    // ===================================================================
    {
      ...
      intro: "What CCD needs access to before paid spend goes live. Check items off as they are granted; most take minutes on the GreatM side and the full list can clear in a day. Spend runs from CCD's own ad accounts.",
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              cta: "CCD verifies the pivot-link domain under Business ID 686135554821430 and configures event priority once pixel placement clears. No Kakao action needed unless the links live on a label-owned domain.",
            },
            {
      ...
      footnote: "Once Meta and TikTok access plus Spark codes clear, the one-week P1 ramp and the paid launch setup run in parallel.",
    },
  ],
};
