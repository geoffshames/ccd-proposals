...
export const zerobaseonePlan: StrategyPlanData = {
  ...
  sections: [
    ...
    // ===================================================================
    {
      ...
      mixRows: [
        { metric: "Posts carrying an explicit ask", subject: "11 of 59 (19%)", benchmark: "4 of 110 (4%)", read: "behind", note: "CORTIS TikTok and BOYNEXTDOOR ask for nothing across 45 posts between them." },
        { metric: "Median TikTok views, top band", subject: "1,459,310", benchmark: "1,454,514 (AND2BLE)", read: "inline", note: "A ratio of 1.00x against a group that debuted in May 2026." },
        { metric: "Median TikTok engagement rate", subject: "0.1890", benchmark: "0.1979 (AND2BLE)", read: "behind", note: "AND2BLE also leads on Instagram at 0.1166 against 0.1033." },
        { metric: "Posts with any Japan signal", subject: "1 of 59", benchmark: "3 of 25 (BOYNEXTDOOR)", read: "behind", note: "The single ZEROBASEONE instance is a Korean transliteration, not Japanese." },
        { metric: "Release or promo assets as a share of output", subject: "8 of 59 (14%)", benchmark: "n/a", read: "neutral", note: "86 percent of output is self-generated, and that is where the winners are." },
        { metric: "Instagram over TikTok, same account", subject: "1.83x inventory, 2.09x top band", benchmark: "n/a", read: "ahead", note: "1.83x across the full post inventory and 2.09x within the top-performing band. The gap holds on every post, not only on cross-posted ones." },
        { metric: "Median post duration, TikTok", subject: "18.3s", benchmark: "15.3s (CORTIS)", read: "neutral", note: "Duration does not explain a thirteen-fold reach gap in either direction." },
      ],
