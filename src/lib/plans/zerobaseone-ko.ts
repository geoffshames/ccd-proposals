...
export const zerobaseonePlanKorean: StrategyPlanData = {
  ...
  sections: [
    ...
    // ===================================================================
    {
      ...
      mixRows: [
        { metric: "명시적인 요청이 포함된 게시물", lolaAmour: "59건 중 11건 (19%)", benchmark: "110건 중 4건 (4%)", read: "behind", note: "CORTIS TikTok과 BOYNEXTDOOR은 총 45개의 게시물에서 어떠한 요청도 하지 않았습니다." },
        { metric: "상위 그룹의 중앙값 TikTok 조회수", lolaAmour: "1,459,310", benchmark: "1,454,514 (AND2BLE)", read: "inline", note: "2026년 5월에 데뷔한 그룹 대비 1.00배의 비율입니다." },
        { metric: "중앙값 TikTok 참여율", lolaAmour: "0.1890", benchmark: "0.1979 (AND2BLE)", read: "behind", note: "AND2BLE은 Instagram에서도 0.1166으로 0.1033 대비 선두를 차지했습니다." },
        { metric: "일본 관련 신호가 있는 게시물", lolaAmour: "59건 중 1건", benchmark: "25건 중 3건 (BOYNEXTDOOR)", read: "behind", note: "ZEROBASEONE의 단일 사례는 일본어가 아닌 한국어 음역입니다." },
        { metric: "출시 또는 홍보 에셋이 전체 결과물에서 차지하는 비중", lolaAmour: "59개 중 8개 (14%)", benchmark: "해당 없음", read: "neutral", note: "콘텐츠의 86%가 자체 생성이며, 여기서 성공 사례가 나옵니다." },
        { metric: "틱톡보다 인스타그램, 동일 계정", lolaAmour: "인벤토리 1.83배, 상위 밴드 2.09배", benchmark: "해당 없음", read: "ahead", note: "전체 게시물 인벤토리 대비 1.83배, 상위 성과 밴드 내에서는 2.09배입니다. 이 격차는 교차 게시물뿐만 아니라 모든 게시물에서 유지됩니다." },
        { metric: "틱톡 게시물 평균 지속 시간", lolaAmour: "18.3초", benchmark: "15.3초 (CORTIS)", read: "neutral", note: "지속 시간으로는 어느 방향으로든 13배의 도달 격차를 설명할 수 없습니다." },
      ],
