  ...
  sections: [
    ...
    // ===================================================================
    {
      ...
      mixRows: [
        {
          metric: "게시 빈도",
          lolaAmour: "53%의 날에 활동, 활동일당 2.37개의 게시물, 하루 최대 10개",
        ...
        {
          metric: "릴리스 및 홍보 에셋",
          lolaAmour: "출력의 13.5%, 중앙값 314K 조회수, 상위 10% 내 인덱스 0.41배",
        ...
        {
          metric: "플랫폼 할당",
          lolaAmour: "119개의 매칭된 쌍 중 인스타그램이 95개를 중앙값 1.58배로 승리했습니다.",
        ...
        {
          metric: "해시태그 수",
          lolaAmour: "게시물당 5.5개의 해시태그, 97.5%가 미러링된 한국어 및 라틴어 쌍을 포함합니다.",
