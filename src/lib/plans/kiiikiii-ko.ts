      ...
      mixRows: [
        {
          ...
          subject: "분석된 코퍼스의 37%; 8월 전체 게시물의 절반",
        ...
        },
        {
          ...
          subject: "카메라를 향한 챌린지 클립은 게시물의 약 50%를 차지하지만, 상위 10% 중에서는 약 14%에 불과합니다.",
        ...
        {
          metric: "전환 요청",
          subject: "68개 게시물 중 1개의 명시적 CTA, 하위권 게시물 내 포함",
        ...
        {
          metric: "인스타그램 전략",
          subject: "분석된 10개의 릴은 모두 동일한 편집, 동일한 텍스트를 가진 틱톡 영상과 똑같습니다.",
        ...
        {
          metric: "영어 접근 계층",
          subject: "캡션은 비한국어로 제공되며, 게시물의 10-20%에 오버레이가 표시되고, 표시될 경우 영어로 제공됩니다.",
