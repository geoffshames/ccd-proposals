...
export const kiiikiiiPlanKorean: StrategyPlanData = {
  ...
  sections: [
    ...
    // ===================================================================
    {
      ...
      philosophy: "미국 차트 순위는 산술적인 결과입니다. 이 워크스트림은 그 산술을 다룹니다.",
      intro: "미국 내 실물 음반 판매는 예측 가능하게 이루어집니다. 즉, 확정된 수의 팬이 확정된 수의 음반 판매로 전환되며, 음반 판매량과 스트리밍이 합쳐져 차트 순위를 결정합니다. 우리의 임무는 먼저 확정된 팬 기반을 구축한 다음, 집계 주간 내에 이를 판매로 전환하는 것입니다.",
      subBlocks: [
        {
          label: "A",
          title: "차트 산술",
          objective: "다양한 수준의 실물 음반 판매가 실제로 어떤 결과를 가져오는지 명확하게 설명하십시오.",
          strategy: "약 100,000명의 확정된 미국 팬이 집계 주간에 일반적인 스트리밍 볼륨과 함께 약 10,000장의 음반 판매로 전환될 경우, 해당 아티스트는 HOT 100 범위에 진입할 수 있습니다. 10,000장에서 20,000장의 사전 주문은 목표를 상위 40위권으로, 상위권에서는 상위 25위권으로 끌어올립니다. 약 1,000장 미만의 판매량의 경우, 실물 음반 판매는 차트 순위 확보보다는 수익 창출을 위한 활동으로 간주되어야 하며, 이에 따라 계획되어야 합니다. 이는 모든 미국 레이블이 계획을 세우는 기준과 동일하며, 워크스트림 1이 구축해야 할 팬 기반의 규모를 결정합니다.",
          charts: [
            {
              kind: "bars",
              title: "사전 주문량에 따른 미국 차트 결과",
              subtitle: "집계 주간 판매량과 일반적인 스트리밍 볼륨을 기준으로 한 미국 차트 예상 순위.",
              series: [
                {
                  name: "집계 주간 판매량",
                  points: [
              ...
              highlightX: ["HOT 100 범위\\n~1만 장"],
              note: "이 기준선은 미국 시장 표준이며 경쟁적인 주간 상황에 따라 변동될 수 있습니다. 이는 계획 범위이지 보장은 아닙니다.",
              source: "미국 차트 계획 표준, 2026",
            },
          ],
        },
        {
          label: "B",
          title: "실행 방안",
          objective: "보유 팬 리스트를 집계 주간 내 판매량으로 전환합니다.",
          strategy: "사전 주문은 공개 발표 전에 자체 팬 리스트를 대상으로 먼저 오픈하여 팬들에게 보상을 제공하고 수요를 조기에 파악합니다. 기존 미국 K팝 유통망을 통한 미국 전용 버전은 해외 직구 대신 현지 구매의 이유를 제공하며, 오프라인 매장 또는 팝업 스토어 이벤트는 캠페인에 사진 촬영거리를, 언론에는 보도거리를 제공합니다. 모든 활동은 단일 집계 주간 내에 완료되도록 시기 조절되며, 여러 주기에 걸쳐 분산되지 않습니다. 잘못된 주간에 판매된 음반은 차트 순위에 아무런 영향을 미치지 않기 때문입니다.",
          components: {
            heading: "구성 요소",
            items: [
              "선주문 기간을 자체 리스트에 먼저 공개",
              "미국 K팝 리테일을 통한 미국 단독 버전",
      ...
      footnote: "실물 앨범 판매량은 발매 일정 및 경쟁 주에 따라 달라집니다. 목표치는 발매일이 확정된 후 설정됩니다.",
    },
    ...
    // ===================================================================
    {
      ...
      subBlocks: [
        ...
        },
        {
          ...
          strategy: "클리핑은 규모가 클 때, 그리고 오직 규모가 클 때만 효과가 있습니다. 1백만 회 노출은 측정 가능한 변화를 일으키지 못합니다. 1억 회 노출은 아티스트를 움직일 수 있습니다. 대략 1달러의 CPM으로 5천만 회 노출은 약 5만 달러가 소요되며, 이 정도 규모에서 해당 전략을 실행할 가치가 있습니다. Crowd Control Digital은 시장에서 가장 큰 클리핑 플랫폼 중 하나의 백엔드를 구축했으며, 에이전시 시장에서는 접근할 수 없는 요율로 구매합니다. 클리핑을 통해 제작된 콘텐츠는 유료 광고에도 라이선스되어 다른 모든 콘텐츠의 제작 비용을 절감합니다.",
          charts: [
            {
              kind: "bars",
              title: "클리핑: 효과의 하한선",
              ...
              highlightX: ["아티스트를 움직일 수 있음\\n100M"],
              note: "대략 1달러의 CPM으로 5천만 회 노출은 약 5만 달러에 해당합니다. 임계값 이하의 지출은 노이즈만 발생시키므로, 소규모로 실행하기보다는 실행하지 않는 것을 선호합니다.",
