...
export const miguelTestSprint: StrategyPlanData = {
  ...
  sections: [
      ...
      tiers: [
        {
          ...
          includes: [
            ...
            "damned execution: clipping, page network, Strive, playlisting, artist content",
            "CCD creative production: ad cutdowns, statics, capture pages",
...

    {
      ...
      intro: "Total bucket: $19,000, deployed across the six programs of the standing campaign plan. Front-loaded into weeks 1 through 4 of the sprint because the window does not wait. Every program carries its own pre-committed success gate.",
      subBlocks: [
        {
          label: "A",
        ...
        {
          label: "D",
          title: "Third-Party Playlisting + DSP Push",
          budget: "$5,000 (scales to $10,000 on traction)",
          objective: "Close the conversion gap: 460K+ daily streams and still zero Spotify editorial placements.",
          strategy: "Vetted independent curator pitching only (2-year growth-chart checks, no guaranteed-stream sellers) across R&B, throwback, and mood playlists, paired with a label-side data memo pushing for editorial consideration, Discovery Mode, and the official sped-up pack. Spend steps to the $10K level only if early adds clear the bar.",
          kpis: [
            "2 or more editorial adds by Day 30",
            "Playlist-sourced streams at 12 percent or more of total by Day 30",
          ],
        },
        {
          label: "E",
          title: "Artist Moment + Official Assets",
          budget: "$3,000 production",
          objective: "One half-day shoot that yields four weeks of official drops and gives the trend an artist-sized accelerant.",
          strategy: "Four deliverables in one setup: a trend reaction + nano-creator duet, a stripped live one-take (which doubles as the CRM capture gift), a lyric-meaning storytime answering the search demand, and a Spanish-language thank-you to Mexico. Label side ships the sped-up + slowed pack and a YouTube visualizer.",
          kpis: [
        ...
        },
        {
          ...
          budget: "$450 reserve / capture layer at no cost",
          objective: "Amplify proven winners and own the audience the trend rented.",
          strategy: "Spark Ads behind the top 3 organic clips only (never cold creative), plus the no-cost capture net: the Hive damned page, comment-seeding squads in English and Spanish, a damned-anchored official playlist spreading the surge across the album, and a radio memo built on the Shazam city data.",
          kpis: [
...

    {
      ...
      intro: "None of the following spend is inside the $33,000 ceiling. Each trigger activates only when its gate clears, on a one-line approval.",
      subBlocks: [
        {
          label: "A",
          title: "Merch Step-Up",
        ...
        {
          label: "B",
          title: "Playlisting Scale-Up",
          budget: "+$5,000",
          objective: "Push the playlisting program to its full $10K design level.",
          strategy: "Gate: at least one editorial add lands, or playlist-sourced streams clear 12 percent of total. The full level projects 300 to 500K playlist-driven streams.",
        },
        {
          label: "C",
...

    {
      ...
      intro: "How the $33,000 deploys across the 45-day window (June 11 through July 25). The damned bucket front-loads while the moment is live; merch and CRM build steadily and finish the sprint carrying the learning. Health checks land June 25, July 9, and July 23.",
      totalBudget: "$33,000 all-in",
      phases: [
        {
          label: "Ignite + Instrument",
          window: "Jun 11-28 / ~2.5 weeks",
          focus: "The damned engine turns on at full force: clipping wave 1, page network live, artist shoot filmed, curator pitching out. Merch launches the creative test at $100 per day with pixel and catalog instrumentation verified. CRM capture pages go live on Hive while consolidation begins. First health check June 25.",
          budget: "~$14,500",
          tactics: [
            "damned: clipping wave 1 ($3K), page network onboard + posting, artist content shoot, playlisting outreach begins",
            ...
            "CCD creative: ad cutdowns, statics, and capture page builds",
          ],
        },
        {
          label: "Convert + Read",
          window: "Jun 29 - Jul 12 / 2 weeks",
          focus: "Attention converts to durable signal. Strive flight launches, curator adds land, clipping wave 2 doubles the winning lane. Merch moves to piece-level and audience testing on the winning angle. CRM offer winner takes the budget; Hive consolidation completes and CAC reporting firms up. Health check July 9.",
          budget: "~$11,000",
          tactics: [
            "damned: Strive flight live ($1.8K), clipping wave 2 ($2K), sped-up pack ships, boost reserve on top organic clips",
            ...
            "Playlisting follow-through with week-one velocity proof to the label",
          ],
        },
        {
...

    {
      ...
      workstreams: [
        ...
        },
        {
          name: "Artist Content",
          cells: [
            { weekIndex: 1, intensity: "high", label: "SHOOT" },
      ...
      weekBreakdowns: [
        {
          ...
          items: [
            ...
            "Miguel half-day shoot filmed: reaction duet, live one-take, storytime, Spanish thank-you",
        ...
        },
        {
          ...
          items: [
            ...
            "Curator pitching out with 2-year growth-chart screening",
          ],
        },
        {
          weekIndex: 3,
        ...
        },
        {
          ...
          items: [
            ...
            "15-minute health check: ROAS by audience tier, playlist adds, stream retention",
          ],
        },
        {
          weekIndex: 6,
      ...
      tiers: [
        {
          ...
          feeBreakdown: {
            ...
            mediaManagement: "$4,050",
            mediaManagementDetail: "15% on $27,000 managed media + programs",
          },
          breakdown: [
            { vertical: "Merch Paid Social ($100/day x 45)", amount: "$4,500" },
            { vertical: "CRM Capture Media (~$75/day x 45)", amount: "$3,500" },
            { vertical: "damned Programs (clipping, pages, Strive, playlisting, content, boost)", amount: "$19,000" },
            { vertical: "CCD Creative Production (cutdowns, statics, capture pages)", amount: "$1,950" },
            { vertical: "CCD Media Management (15% on managed spend)", amount: "$4,050" },
          ],
        },
      ],
      footnote: "Scale triggers (merch step-up, playlisting to $10K, LATAM page two, CRM scale flight) sit outside this ceiling and activate on their gates via one-line approval. Biweekly 15-minute health checks: June 25, July 9, July 23.",
    },
  ],
};
