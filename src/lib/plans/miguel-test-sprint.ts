...
export const miguelTestSprint: StrategyPlanData = {
    ...
    cover: {
          label: "Test & Learn Sprint / July Through August",
          title: "MIGUEL",
          subtitle: "An eight-week, four-bucket test flight: merchandise, first-party CRM, the damned moment, and the LATAM push. Every dollar reports revenue against spend.",
    ...
    sections: [
      {
              ...
              subtitle: "One all-in number, four revenue-accountable buckets, and a defined set of tests. The sprint exists to produce the data that sizes the fall album and tour budget.",
              body: [
                        "This plan operationalizes the standing mandate: be prescriptive, fund a test-and-learn window, and report every bucket as dollars in versus revenue out. The budget below is sized to avoid false positives without being bloated. Each bucket carries its own tests, its own success gates, and its own pre-committed scale rule, so by the end of the window we know exactly what a dollar buys in each lane. The window runs eight weeks, July 6 through August 30, long enough for every workstream to clear its approval cycles and still produce a clean ROI read.",
                        "Four buckets run in parallel. Merchandise tests creative, pieces, and audiences against the leftover tour inventory at a steady $100 per day, with a hard ROAS gate before any scale-up. First-party CRM runs straight data capture into Hive, where email and SMS both live, so we can price a contact with real CAC math once consolidation lands. damned, the live catalog moment at 600K plus streams per day, leads the plan and front-loads while the window is open. And LATAM opens at a mid-level push: Spanish-language creator seeding, Spanish-language clipping, and a paid flight across Meta and Google Ads with YouTube as the spearhead.",
                        "Content operations run on one calendar. CCD quarterbacks a ClickUp content calendar, Red Light's edit support cuts from the approved tour-footage archive, and Miguel signs off on a 72-hour approval window so assets ship on schedule. Reporting runs weekly: a written report plus a 15 to 20 minute group call, with deep-dive checkpoints July 22, August 5, and August 19, and a full readout plus a fall scale proposal in the final week.",
                      ],
              supports: {
                        heading: "What This Sprint Supports",
                        items: [
                                    "The damned catalog moment while the window is live",
                                    "Post-tour merchandise sell-through on the roughly $85K of remaining inventory",
                                    "CRM consolidation onto Hive and compounding owned-list growth, with every workstream routing captured audience back to S1C",
                                    "A first structured LATAM push at test scale",
                                    "The fall album and tour budget, sized on this sprint's data",
                                  ],
              },
              goals: {
                        heading: "What We Will Know by Week 8",
                        items: [
                                    ...
                                    "LATAM: what a dollar buys in Mexico across seeding, clipping, and paid, and whether the market earns a bigger fall weighting",
                                    "The scale case: where each incremental dollar should go in the fall and beyond",
                                  ],
              },
...

      {
              ...
              hierarchy: [
                ...
                },
                {
                            ...
                            description: "Every contact captured is owned forever and monetizes across every future lane: merch drops, presales, releases. Email and SMS both consolidate onto Hive, and the sprint prices the contact while consolidation unifies the list. A proven sub-$5 CPA against a $20-plus annual value per contact is the strongest scale argument in this entire plan.",
                },
                {
                            label: "damned (The Live Catalyst)",
                            description: "A use-it-or-lose-it catalog moment. The trend already peaked on creation and streams are still accelerating, which is precisely the conversion window. This bucket runs the existing campaign plan: paid clipping volume, owned page network, real-listener streaming, and official artist assets, all pointed at one record.",
                },
                {
                            label: "LATAM (The Expansion Surface)",
                            description: "Miguel's five biggest cities in the world are all Mexican and LATAM is roughly a quarter of the fanbase, yet the content infrastructure is US-first. The sprint funds a mid-level push: Spanish-language creator seeding, Spanish-language clipping, and paid social including a dedicated Google Ads flight behind YouTube, all routed back to owned capture.",
                },
                      ],
              messaging: [
                        ...
                        "Everything captured (purchasers, contacts, listeners) feeds the fall campaign as warm audience infrastructure, and every workstream routes audience back to S1C and the owned list.",
                      ],
...

      {
              ...
              intro: "One all-in number for the eight-week sprint (July 6 through August 30). CCD fees sit inside the budget, not on top. Merch, CRM, and LATAM run the full window; damned front-loads into the first four weeks while the moment is live. The fall album and tour cycle authorizes a fresh budget on the same structure.",
              tiers: [
                {
                            label: "Test & Learn Sprint",
                            budget: "$44,050",
                            name: "All-In Budget",
                            goal: "Run four revenue-accountable buckets for eight weeks: merch creative-to-scale testing at $100 per day, CRM capture at $50 to 100 per day into Hive, the full damned execution stack, and a mid-level LATAM push. Exit with real CAC, real ROAS, and a data-sized fall proposal.",
                            featured: true,
                            includes: [
                                          "Merch paid social: creative, piece, and audience tests concurrent from week 1, with a hard scale gate",
                                          "CRM capture flights with offer, channel, and geo splits, with email and SMS consolidated on Hive",
                                          "damned execution: clipping, page network, Strive, and a $3K boost reserve behind winners",
                                          "LATAM mid-level push: Spanish-language creator seeding, clipping, and paid social including a Google Ads flight behind YouTube",
                                          "Content operations: a ClickUp calendar CCD quarterbacks, Red Light edit support cutting from the approved tour archive, and artist sign-off on a 72-hour window",
                                          "Weekly reporting plus a weekly 15 to 20 minute group call, with a full end-of-sprint readout",
...

      {
              ...
              intro: "Total bucket: $5,600 in media ($100 per day x 56 days). Runs on Meta (IG + FB) with Shopify as the source of truth. Store access is already granted. Creative feeds off product flats and on-body shots sourced through the web and merch partners, with CCD running the asset chase so nothing waits on a photoshoot. Creative, piece, and audience tests all launch in the week 1 window; budget never exceeds $100 per day until the scale gate clears.",
              subBlocks: [
                {
                            label: "A",
                ...
                },
                {
                            ...
                            components: {
                                          ...
                                          items: [
                                                          ...
                                                          "Blended account ROAS holds 3.5x+ for 7 days: CCD proposes the September step-up to $250 to 500 per day",
              ...
              footnote: "Estimated bucket spend lands in the $4,000 to 6,000 range depending on in-flight kills and the gate; $5,600 is budgeted. Every dollar saved reallocates inside the sprint.",
      },

      {
              ...
              intro: "Total bucket: $4,200 in media (roughly $75 per day x 56 days, flexing $50 to 100 per day). Pure data capture measured in Hive, with email and SMS both running on Hive from capture through broadcast: SMS is the direct-line channel, and it lives here. The sprint prices a contact so list growth can scale on real math.",
              subBlocks: [
                {
                            label: "A",
                            ...
                            strategy: "Klaviyo and S1C stop fighting for attention: both consolidate into Hive over the next 30 days. The artist account is already live from mid-tour, CCD has a direct line to Hive's engineering leadership for the custom S1C integration, and capture pages run on Hive from week one so paid never waits on migration. Email and SMS broadcast from the same consolidated list.",
                            components: {
                                          heading: "Workstream",
                                          items: [
                ...
                {
                            label: "C",
                            title: "Geo Split + The Scale Case (Weeks 4-8)",
                            ...
                            strategy: "Miguel's five biggest cities in the world are all Mexican. A US vs. MX split tells us whether LATAM list growth is materially cheaper, which would reshape how the fall budget allocates, and it reads directly against the LATAM bucket's paid flight. The end-of-sprint readout converts proven CPA into a funded path toward the contact target, layered with the label list pull and S1C integration.",
                            components: {
                                          heading: "Tests",
                                          items: [
...

      {
              ...
              subBlocks: [
                ...
                },
                {
                            ...
                            strategy: "Reaction and UGC formats lead: Miguel duetting the fan content that is already winning, a stripped live one-take (which doubles as the CRM capture gift), a lyric-meaning storytime answering the search demand, a Spanish-language thank-you to Mexico, and the sped-up + slowed versions. Capture stays deliberately lightweight: studio-session footage and a backyard-style acoustic take beat LED-and-pyro productions, and when a shoot needs a lens CCD dispatches a vetted shooter at roughly $500 a day, billed at cost. CCD briefs, edits, and schedules everything through the ClickUp calendar and the existing posting pipeline; the label ships the official pack and a YouTube visualizer.",
                            kpis: [
                                          "All four artist drops live on schedule across the window",
                ...
                },
                {
                            ...
                            strategy: "Spark Ads only, behind the top organic clips, page winners, and Miguel's own trend posts (never cold creative), deployed in $500 to 750 increments at peak velocity. Plus the no-cost capture net: comment-seeding squads in English and Spanish, a damned-anchored official playlist spreading the surge across the album, and a radio memo built on the Shazam city data.",
                            kpis: [
                                          "Boost spend deployed only behind clips already beating account benchmarks",
...

      {
              ...
              number: "07",
              navLabel: "LATAM",
              title: "Bucket 4 / LATAM Mid-Level Push",
              philosophy: "Miguel's five biggest cities in the world are all Mexican, LATAM is roughly a quarter of the fanbase, and the content infrastructure is US-first. This bucket opens the market deliberately: Spanish-language supply, real creator adoption, and paid distribution with YouTube as the spearhead, all routed back to owned capture.",
              intro: "Total bucket: $15,000 across three programs, running weeks 2 through 8 behind translated briefs and the approved tour-footage archive. Mexico first, with Chile and Colombia as fast-follow reads. Every program reports the same way as the US buckets: dollars in, movement out.",
              subBlocks: [
                {
                            label: "A",
                            title: "Creator Seeding",
                            budget: "$5,000",
                            objective: "Real Spanish-language creator adoption on the proven lanes, not rented macro reach.",
                            strategy: "MX-first creator seeding with trend-native briefs: damned ES angles, catalog rediscovery, and CAOS-era nostalgia. Sound adoption over polish; nano and mid-tier creators over expensive macros, because the volume data says the sound carries the video. Briefs and payouts run through CCD's standing creator network.",
                            components: {
                                          heading: "Tests",
                                          items: [
                                                          "Lane test: damned ES angles vs. catalog rediscovery vs. CAOS nostalgia",
                                                          "Creator tier test: nano volume vs. mid-tier reach on identical briefs",
                                                          "Sound adoption read: official-sound share across seeded posts",
                                                        ],
                            },
                            kpis: [
                                          "Seeded posts live across MX-first creators with CPV benchmarked by lane",
                                          "Mexico monthly listener trend visibly moving by the end of the flight",
                                          "Winning lane identified and doubled into by week 6",
                                        ],
                },
                {
                            label: "B",
                            title: "Spanish-Language Clipping / Edits",
                            budget: "$5,000 (est. $1 to 2 CPM)",
                            objective: "Volume supply in Spanish: the same clip engine that runs the US damned push, translated.",
                            strategy: "Spanish-caption clip briefs cut from the approved tour-footage archive and the existing ES asset bank (Perderme, Caramelo Duro, the Spanish versions of catalog records). Payout is CPM-based, so the budget spends exactly as fast as verified views come in, and briefs rotate weekly toward whatever the view data rewards.",
                            components: {
                                          heading: "Tests",
                                          items: [
                                                          "ES lyric edits vs. tour-footage clips vs. meaning-explainer formats",
                                                          "MX-geo posting windows vs. US posting windows",
                                                          "damned ES captions vs. catalog-wide briefs",
                                                        ],
                            },
                            kpis: [
                                          "Verified views delivered at $2.00 or under blended CPM",
                                          "Clip-sourced profile visits and follows from MX geos",
                                          "ES creates and engagement share trending up week over week",
                                        ],
                },
                {
                            label: "C",
                            title: "Paid Social + YouTube Flight",
                            budget: "$5,000",
                            objective: "Paid distribution behind the winners, with a dedicated Google Ads flight putting YouTube in front of the LATAM audience.",
                            strategy: "Split flight: Meta (IG + FB) behind proven Spanish-language cuts, and a Google Ads flight running YouTube in-feed and Shorts placements across Mexico and LATAM majors. Every click lands on capture (Hive) or the streaming surface, never a dead end, and the MX capture read feeds the CRM bucket's geo split directly.",
                            components: {
                                          heading: "Tests",
                                          items: [
                                                          "Meta vs. Google Ads (YouTube) efficiency on identical creative",
                                                          "MX capture CPA vs. the US baseline on mirrored offers",
                                                          "YouTube Shorts vs. in-feed placements on watch-through and click-through",
                                                        ],
                            },
                            kpis: [
                                          "CPV / CPC by market with a US-vs-MX efficiency read",
                                          "Capture CPA in MX benchmarked against the US flight",
                                          "YouTube view and subscriber lift on the artist channel from MX geos",
                                        ],
                },
                      ],
              footnote: "The LATAM fan and volume page network is available as an add-on: two dedicated Spanish-language pages at $5,000 per month, activating on a one-line approval and slotting into this bucket's posting lanes.",
      },

      {
              ...
              intro: "None of the following spend is inside the $44,050 ceiling. Each trigger activates only when its gate clears, on a one-line approval.",
              subBlocks: [
                {
                            label: "A",
                            title: "Merch Step-Up",
                            budget: "+$250 to 500/day (September onward)",
                ...
                },
                {
                            ...
                            objective: "Close the conversion gap: 600K+ daily streams and still zero Spotify editorial placements.",
                ...
                {
                            label: "C",
                            title: "LATAM Fan / Volume Page Network",
                            budget: "+$5,000/mo (2 pages)",
                            objective: "Always-on Spanish-language page supply against the cheapest expansion surface in the plan.",
                            strategy: "Two dedicated fan / volume pages at a flat monthly rate, running translated lyric formats, CAOS tour clips, and the LATAM bucket's clipping winners. Available on a one-line approval from day one, or triggered by the gate: Mexico monthly listeners visibly inflect during the sprint, or MX capture CPA undercuts US by 30 percent or more.",
                },
                {
                            label: "D",
...

      {
              ...
              intro: "How the $44,050 deploys across the eight-week window (July 6 through August 30). The damned bucket front-loads while the moment is live; merch, CRM, and LATAM build steadily and finish the sprint carrying the learning. Playlisting sits outside this number as the phase 2 unlock. Deep-dive checkpoints land July 22, August 5, and August 19 inside the weekly call cadence.",
              totalBudget: "$44,050 all-in",
              phases: [
                {
                            label: "Ignite + Instrument",
                            window: "Jul 6-19 / 2 weeks",
                            focus: "The damned engine turns on at full force: clipping briefs live, page network posting, Miguel's content batch briefed and in production. The ClickUp content calendar stands up with edit support and the approval flow locked. Merch launches the creative test at $100 per day with pixel and catalog instrumentation verified. CRM capture pages go live on Hive while consolidation begins. LATAM briefs translate and the creator slate locks.",
                            budget: "~$16,000",
                            tactics: [
                                          ...
                                          "LATAM: briefs translated, creator slate locked, first ES clip briefs cut from the approved archive",
                                        ],
                },
                {
                            label: "Convert + Read",
                            window: "Jul 20 - Aug 9 / 3 weeks",
                            focus: "Attention converts to durable signal. Strive launches and Spark boosts go to work behind proven posts while the clipping cap pays out on delivered views. LATAM goes fully live: seeded creator posts land, ES clipping spends, and the Meta + Google Ads flight ignites behind early winners. The phase 2 playlisting unlock gets its go / no-go call. Merch moves to piece-level and audience reads; the CRM offer winner takes the budget while Hive consolidation completes.",
                            budget: "~$16,500",
                            tactics: [
                                          "damned: Strive flight live ($1.8K), sped-up pack ships, Spark boosts scaling behind winners",
                                          "LATAM: seeding + ES clipping at full pace; Meta + Google Ads (YouTube) flight live across MX and LATAM majors",
                ...
                },
                {
                            ...
                            window: "Aug 10-30 / 3 weeks",
                            focus: "Budget consolidates behind whatever cleared its gate. The merch scale rule executes mechanically. The CRM scale model gets written from real CAC. The LATAM read lands: CPV, capture CPA, and listener movement by market, plus the fan-page add-on call. Final checkpoint August 19, then the full readout and the fall album + tour proposal.",
                            budget: "~$11,550",
                            tactics: [
                                          ...
                                          "LATAM: market-by-market read, fan-page add-on go / no-go, fall weighting recommendation",
...

      {
              ...
              intro: "Week-by-week deployment across the eight-week window. The damned workstreams run hot in weeks 1 through 4 while the moment is live. Merch, CRM, and LATAM build through the full window and carry the sprint's learning into the readout. Weekly group calls throughout, with deep-dive checkpoints in W3, W5, and W7.",
              weeks: [
                { index: 1, label: "W1", dates: "Jul 6" },
                { index: 2, label: "W2", dates: "Jul 13" },
                { index: 3, label: "W3", dates: "Jul 20" },
                { index: 4, label: "W4", dates: "Jul 27" },
                { index: 5, label: "W5", dates: "Aug 3" },
                { index: 6, label: "W6", dates: "Aug 10" },
                { index: 7, label: "W7", dates: "Aug 17" },
                { index: 8, label: "W8", dates: "Aug 24", highlight: true, note: "READOUT" },
                      ],
              workstreams: [
                {
                            name: "Merch Ads",
                            cells: [
                              ...
                              { weekIndex: 8, intensity: "high", label: "GATE" },
                                        ],
                },
                {
                            name: "CRM Capture",
                            cells: [
                              ...
                              { weekIndex: 7, intensity: "medium", label: "SCALE" },
                              { weekIndex: 8, intensity: "medium", label: "READ" },
                                        ],
                },
                {
                            name: "Hive Migration",
                ...
                {
                            name: "LATAM Paid + YouTube",
                            cells: [
                              { weekIndex: 3, intensity: "medium", label: "LAUNCH" },
                              { weekIndex: 4, intensity: "high" },
                              { weekIndex: 5, intensity: "high" },
                ...
                },
                {
                            ...
                            cells: [
                              { weekIndex: 1, intensity: "high", label: "STAND UP" },
                ...
                },
                {
                            ...
                            cells: [
                              ...
                              { weekIndex: 7, intensity: "medium", label: "CHECK" },
                              { weekIndex: 8, intensity: "high", label: "DECIDE" },
                                        ],
                },
                      ],
              weekBreakdowns: [
                {
                            ...
                            items: [
                                          ...
                                          "ClickUp content calendar stands up: lanes, owners, edit support on the approved tour archive, and the 72-hour approval flow locked",
                                          ...
                                          "Miguel content batch briefed: reaction duet, live one-take, storytime, Spanish thank-you, sped/slowed versions; studio-session capture scoped",
                                        ],
                },
                {
                            weekIndex: 2,
                            ...
                            items: [
                                          ...
                                          "LATAM: briefs translated, creator slate locked, first ES clip briefs out",
                                          "First boost increments behind early organic winners",
                                        ],
                },
                {
                            weekIndex: 3,
                            title: "Checkpoint 1 (Jul 22)",
                            items: [
                                          "Strive flight launches geo-weighted to Shazam-spiking cities",
                                          "LATAM seeded creator posts start landing; Meta + Google Ads (YouTube) flight launches",
                                          "Phase 2 playlisting unlock: go / no-go on the weeks 1-2 data",
                                          "Merch: first winner reads across angle, piece, and audience",
                                          "Deep-dive checkpoint: creates curve, CTR reads, capture CPA",
                                        ],
                },
                {
                            weekIndex: 4,
                            ...
                            items: [
                                          ...
                                          "LATAM ES clipping at full pace; first MX capture CPA reads",
                                          "Hive migration QA; consolidation on track for the 30-day checkbox",
                                        ],
                },
                {
                            weekIndex: 5,
                            title: "Checkpoint 2 (Aug 5) + Hive live",
                            items: [
                                          ...
                                          "LATAM winners identified; budget concentrates behind the proving lane",
                                          "Deep-dive checkpoint: ROAS by audience tier, Strive pacing, stream retention",
                                        ],
                },
                {
                            weekIndex: 6,
                            ...
                            items: [
                                          ...
                                          "LATAM: Google Ads flight optimizes toward the winning placements",
                                        ],
                },
                {
                            weekIndex: 7,
                            title: "Checkpoint 3 (Aug 19)",
                            items: [
                                          "LATAM read: CPV and capture CPA by market against the US baseline",
                                          "Fan-page add-on go / no-go on the listener and CPA gates",
                                          "Merch and CRM gates re-evaluated on the full data window",
                                          "Deep-dive checkpoint: the fall weighting conversation starts",
                                        ],
                },
                {
                            weekIndex: 8,
                            title: "Readout + the fall proposal (week of Aug 24)",
                            items: [
                                          "Final group call, then the full readout: dollars-in / revenue-out per bucket",
...

      {
              ...
              intro: "One all-in number for the eight-week sprint. The only CCD fee inside this budget is media management at 15 percent on managed spend; creative is handled within the existing engagement and Miguel produces the artist content himself. The current retainer continues per the existing agreement and is not duplicated here. The fall album and tour cycle authorizes a fresh budget on the same structure.",
              tiers: [
                {
                            label: "Test & Learn Sprint",
                            budget: "$44,050",
                            name: "All-In Budget",
                            tagline: "All-in for the eight-week window (July 6 through August 30): four revenue-accountable buckets, every test gated, readout and fall proposal included.",
                            featured: true,
                            deployable: "$38,350",
                            feeBreakdown: {
                                          retainer: "$0 incremental",
                                          retainerDetail: "Current retainer continues per existing agreement",
                                          mediaManagement: "$5,700",
                                          mediaManagementDetail: "15% on $38,350 managed, rounded down",
                            },
                            breakdown: [
                              { vertical: "Merch Paid Social ($100/day x 56)", amount: "$5,600" },
                              { vertical: "CRM Capture Media (~$75/day x 56)", amount: "$4,200" },
                              { vertical: "damned Programs (clipping $5K, pages $3,750, Strive $1,800, boost $3K)", amount: "$13,550" },
                              { vertical: "LATAM Push (seeding $5K, ES clipping $5K, paid social + YouTube $5K)", amount: "$15,000" },
                              { vertical: "CCD Media Management (15% on managed spend)", amount: "$5,700" },
                                        ],
                },
                      ],
              footnote: "Scale triggers (merch step-up, the phase 2 playlisting unlock, the LATAM page network, CRM scale flight) sit outside this ceiling and activate on their gates via one-line approval. Fees and spend flight across the window in three to four installments tied to checkpoints. Weekly reporting plus a weekly 15 to 20 minute group call; deep-dive checkpoints July 22, August 5, and August 19.",
      },
        ],
};
