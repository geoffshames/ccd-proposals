...
export const eightyTwoMajorSeptember: StrategyPlanData = {
  ...
  sections: [
    ...
    // ===================================================================
    {
      ...
      intro: "The U.S. is now 82MAJOR's largest Spotify market at 70,205 monthly listeners, ahead of Indonesia, the Philippines, and Malaysia. That is a change this campaign created, and it sets the targeting stacks the paid and creator lanes run against. The brackets below are the audiences the September campaign buys.",
      brackets: [
        {
          label: "Core fandom",
          ageRange: "18-24",
          share: "~54%",
          geo: ["Los Angeles", "New York", "Chicago", "Dallas", "Atlanta"],
          psychographics: [
            "Already following the group or an adjacent fifth-generation act",
            "High participation: streams, saves, comments, buys physicals",
            "Discovers through fan edits and short-form before official channels",
          ],
          channels: ["TikTok", "Instagram Reels", "Spotify", "X"],
          note: "This is the retargeting and CRM base. Release week converts this bracket first, then paid expands off it with lookalikes.",
        },
        {
          label: "Genre-adjacent discovery",
          ageRange: "18-29",
          share: "~28%",
          geo: ["Los Angeles", "New York", "Houston", "Phoenix", "Seattle"],
          psychographics: [
            "Listens to melodic R&B and hip-hop, not necessarily K-pop first",
            "Reached through culture-first edits attached to shows, films, and trending audio",
            "Converts on the song, not the group, then discovers the group second",
          ],
          channels: ["TikTok", "YouTube Shorts", "Instagram Reels"],
          note: "The cheapest reach in the SIGN cycle came from here. Culture-first creative is what opens this bracket, which is why the creative guardrail keeps rival-group content out and trending shows and sounds in.",
        },
        {
          label: "Millennial halo",
          ageRange: "25-34",
          share: "~18%",
          geo: ["Los Angeles", "New York", "San Francisco", "Washington DC", "Boston"],
          psychographics: [
            "Passive K-pop listener, playlist-led rather than fandom-led",
            "Higher ticket-buying intent for the Q4 tour window",
            "Responds to production and vocal craft framing over concept framing",
          ],
          channels: ["Spotify editorial", "Instagram", "YouTube"],
          note: "Lowest engagement rate but highest live-conversion value. Worth holding in the mix specifically as the tour window approaches.",
        },
      ],
      footnote: "Bracket shares are directional, derived from platform audience reporting across the SIGN campaign flight. Geographic priority follows Chartmetric city data pulled August 6, 2026, where Los Angeles now ranks in the group's global top ten cities.",
    },
