...
export const eightyTwoMajorSeptember: StrategyPlanData = {
  ...
  sections: [
    ...
    // ===================================================================
    {
      ...
      philosophy: "This is the amplifier, and it is the lane with the hardest numbers behind it. The SIGN flights found an $0.08 TikTok click, a 6.48 percent Meta click-through rate, and a $2.94 CPM on culture-first clipping. The September plan spends against those measured rates rather than against estimates.",
      subBlocks: [
        {
          label: "A",
          ...
          kpis: ["Blended CPM at or below $5.48", "Cost per click at or below $0.10", "Click-through rate on lead creative"],
        },
        {
          label: "B",
