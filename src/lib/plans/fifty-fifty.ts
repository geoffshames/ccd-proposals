      ...
      charts: [
        {
          ...
          subtitle: "Monthly listeners found a floor. Followers never stopped climbing.",
          unit: "people",
          series: [
            {
          ...
          note: "The two lines cross in behavior, not in value. Listeners fell 83.7 percent from the June 2023 peak and then stabilized around 6.1M. Followers added 329,398 in the last twelve months alone against flat listeners, which is fan accumulation rather than decay arithmetic.",
      ...
      workstreams: [
        {
          ...
          cells: [
            { weekIndex: 1, intensity: "high", milestone: true, label: "Bio links repointed" },
            { weekIndex: 2, intensity: "high" },
            { weekIndex: 3, intensity: "high", label: "Landing page live" },
            ...
            { weekIndex: 8, intensity: "medium", milestone: true, label: "First 10K captured" },
        ...
        },
        {
          ...
          cells: [
            ...
            { weekIndex: 2, intensity: "high", label: "Gaming franchise defined" },
        ...
        },
        {
          ...
          cells: [
            ...
            { weekIndex: 5, intensity: "high", milestone: true, label: "Capture campaigns" },
            { weekIndex: 6, intensity: "high" },
            { weekIndex: 7, intensity: "high" },
        ...
        },
        {
          ...
          cells: [
            ...
            { weekIndex: 7, intensity: "medium", label: "Audio asset claim" },
            { weekIndex: 8, intensity: "medium" },
            { weekIndex: 9, intensity: "high", milestone: true, label: "Release surfaces" },
            { weekIndex: 10, intensity: "high" },
            { weekIndex: 11, intensity: "medium" },
            { weekIndex: 12, intensity: "medium" },
          ],
        },
        {
          ...
          cells: [
            ...
            { weekIndex: 2, intensity: "medium", label: "Retail gap review" },
            { weekIndex: 3, intensity: "medium" },
            { weekIndex: 4, intensity: "medium" },
            { weekIndex: 5, intensity: "high", label: "Version plan set" },
            { weekIndex: 6, intensity: "high", milestone: true, label: "Membership live" },
            { weekIndex: 7, intensity: "high" },
            { weekIndex: 8, intensity: "high", label: "Lightstick greenlit" },
        ...
        },
        {
          ...
          cells: [
            ...
            { weekIndex: 8, intensity: "medium" },
            { weekIndex: 9, intensity: "high" },
            { weekIndex: 10, intensity: "high", milestone: true, label: "US date announced" },
