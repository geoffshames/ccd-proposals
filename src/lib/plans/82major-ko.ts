...
export const eightyTwoMajorPlanKorean: StrategyPlanData = {
  ...
  sections: [
    ...
    // ===================================================================
    {
      ...
      subBlocks: [
        ...
        },
        {
          label: "B",
          title: "$25,000",
          budget: "지정된 릴리즈 시점에 맞춰 조율된 미국 라디오 푸시. 라디오는 팬덤 및 디지털 스택과는 다른 타임라인과 관계 구축 속도를 가지므로 별도 예산 책정.",
          objective: "구성 요소",
          components: {
            heading: "방송국 관계 구축 (얼터너티브, 탑-40, AAA, 대학 방송)",
            items: [
    ...
    // ===================================================================
    {
      ...
      addOns: [
        { name: "$25,000", budget: "미국 라디오 홍보, 스핀 타겟팅, 방송국 관계, 온에어 프리미어. 릴리스 시점별 발동.", description: "A&R / 피처링 전략" },
