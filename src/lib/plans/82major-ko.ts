      ...
      tiers: [
        {
          ...
          feeBreakdown: {
            ...
            mediaManagementDetail: "~$18K 관리 수수료 15%",
          },
          breakdown: [
            { vertical: "미국 본사 스타일 팬 페이지", amount: "$14,500" },
            { vertical: "유료 소셜 광고 (IG + TikTok + X)", amount: "$10,000" },
            { vertical: "인플루언서", amount: "$3,000" },
            { vertical: "클리핑 / 시딩", amount: "$4,000" },
            { vertical: "Strive.fm (월 $1,500 한도)", amount: "$3,000" },
            { vertical: "YouTube 광고", amount: "$5,000" },
            { vertical: "CCD 리테이너 + 관리 수수료", amount: "$10,500" },
          ],
        },
        {
          label: "Tier 02",
          ...
          feeBreakdown: {
            ...
            mediaManagementDetail: "~$44K 관리 수수료 15%",
          },
          breakdown: [
            { vertical: "미국 본사 스타일 팬 페이지 (확장)", amount: "$22,000" },
            { vertical: "유료 소셜 광고 (IG + TikTok + X)", amount: "$22,000" },
            { vertical: "인플루언서", amount: "$12,000" },
            { vertical: "클리핑 / 시딩", amount: "$8,000" },
            { vertical: "Spotify 플레이리스트 등록", amount: "$7,500" },
            { vertical: "Strive.fm (월 $1,500 한도)", amount: "$4,500" },
            { vertical: "YouTube 광고", amount: "$10,000" },
