      ...
      tiers: [
        {
          ...
          feeBreakdown: {
            ...
            mediaManagementDetail: "관리되는 미디어 지출 약 $22.5K에 대해 15%",
          },
          breakdown: [
            { vertical: "미국 본사 스타일 팬 페이지", amount: "$12,000" },
            { vertical: "유료 소셜 광고 (IG + TikTok + X)", amount: "$22,500" },
        ...
        },
        {
          ...
          feeBreakdown: {
            ...
            mediaManagementDetail: "관리되는 미디어 지출 약 $42K에 대해 15%",
          },
          breakdown: [
            { vertical: "미국 본사 스타일 팬 페이지", amount: "$12,000" },
            { vertical: "유료 소셜 광고 (IG + TikTok + X)", amount: "$24,000" },
            { vertical: "인플루언서", amount: "$13,000" },
            { vertical: "클리핑 / 시딩", amount: "$8,000" },
            { vertical: "Spotify 플레이리스트 등록", amount: "$10,000" },
            { vertical: "Strive.fm", amount: "$4,500" },
            { vertical: "YouTube 광고", amount: "$5,000" },
            { vertical: "체험형 / OOH", amount: "$10,000" },
