...
export const ecaderPlanKorean: StrategyPlanData = {
  accentColor: "#FD3737",
  ogImage: "/images/ecader/og-image.png",
  language: "ko",
  languageAlternates: [{ slug: "ecader", label: "English", code: "EN" }],
  ...
  sections: [
    ...
    // ===================================================================
    {
      ...
      title: "개요 및 목표",
      subtitle:
        "아직 음악이 존재하지 않는 상태에서 ECADER를 위한 홍보, 참여 및 자체 잠재고객을 구축하는 데뷔 전 캠페인으로, WAYF BOYS가 곡을 단 한 곡도 발매하지 않고도 거의 100만 명의 팔로워를 확보했던 것과 동일한 플레이북을 사용합니다.",
      body: [
        "ECADER는 11월까지 음악이 없습니다. 기회는 그 앞에 놓인 7개월입니다. 7월에 주간 다큐멘터리 시리즈가 공개되며, 이 콘텐츠는 그룹이 데뷔하기도 전에 필연적으로 느껴지도록 설계된 인위적인 모멘텀 캠페인의 연료가 됩니다.",
        "벤치마크는 명확합니다: WAYF BOYS. 그들은 거의 유료 미디어 없이, 유한하고 복제 가능한 플레이북을 실행하여 얼굴, 이름, 노래를 공개하기 전에 최상위 5세대 데뷔 궤적을 구축했습니다. 우리는 그 플레이북을 완전히 역공학했습니다. 이 계획은 의도적인 클리핑, 팬 페이지 네트워크, 우승작에 대한 유료 증폭, 그리고 홍보를 데이터, 유닛 및 차트 스토리로 전환하는 경험적 계층을 통해 더 타이트하고 유료 가속화된 버전으로 ECADER에 이를 적용합니다.",
        "운영 예산은 11월 데뷔로 이어지는 7월부터 9월까지의 데뷔 전 기간(약 12주)에 맞춰 50,000달러로 책정되었습니다. 아직 스트리밍할 음악이 없으므로, 성공은 데뷔 전에 실제로 승리하는 방식, 즉 팔로워 속도, 참여율, 노출량, 대화 감성 및 확보된 잠재고객으로 측정됩니다. 각 후속 단계(11월 싱글, 데뷔, 첫 컴백)는 동일한 구조에 따라 새로운 예산을 승인합니다.",
      ],
      supports: {
    ...
    // ===================================================================
    {
      ...
      title: "제안 구조",
      intro:
        "데뷔 전 기간(7월부터 9월까지)을 위한 단일 통합 워킹 미디어 예산은 $50,000이다. 7월에 클리핑, 팬 페이지 2개, Origin 게재 구매, 유료 소셜, SWRM을 가동하고, 8월에 성과가 검증된 항목을 확장하며, 11월 데뷔로 이어지는 활주로로서 9월까지 화제성을 유지한다. CCD 캠페인 리테이너(정액 $5,000)와 15% 미디어 운용 수수료는 이 워킹 예산 안이 아니라 그 위에 별도로 부과된다. 11월 싱글과 데뷔는 각각 동일한 구조로 새로운 예산을 승인한다.",
      tiers: [
        {
          label: "데뷔 전 기간 (7월~9월)",
          budget: "$50,000",
          name: "워킹 미디어 예산",
          goal:
            "다큐멘터리 공개와 함께 7월에 폭발적으로 시작하고, 8월에 검증된 성과 항목을 확장하며, 9월까지 화제성을 유지한다. 11월 싱글과 공식 데뷔로 이어지는 12주간의 의도적으로 만들어낸 데뷔 전 성장 속도.",
          featured: true,
          includes: [
      ...
      subBlocks: [
        {
          ...
          objective:
            "ECADER 다큐멘터리를 이번 사이클에서 가장 많이 클리핑되는 데뷔 전 콘텐츠로 만든다. 양을 위한 양이 아니라 의도적이고 영리하며 콘셉트에 부합하는 클리핑이다. WAYF는 좋은 클리핑이 많은 클리핑보다 낫다는 것을 입증했다.",
          strategy:
            "Brian의 18만 명 규모 클리핑 서버를 포함한 관리형 클리퍼 네트워크 전반에 다큐멘터리 에피소드와 콘셉트 콘텐츠를 배포하되, 어떤 순간, 어떤 훅, 어떤 사운드를 쓸지에 대한 정교한 크리에이티브 디렉션을 적용한다. 클립이 추적 가능한 오디오 흔적을 남기도록 사운드 사용을 조율한다(특정 사운드를 누가 썼는지로 네트워크를 추적하는 것과 같은 방식이다). 이는 Origin과 병행 운영되어, 동일한 콘텐츠를 두 번째 각도에서 한 번 더 공략한다.",
          components: {
            heading: "네트워크의 역할",
            items: [
    ...
    // ===================================================================
    {
      ...
      subBlocks: [
        ...
        },
        {
          ...
          objective:
            "모든 ECADER 콘텐츠와 그 주변에 배포된 클립 전반에 걸쳐 실제 사용자들의 대화와 사회적 증거를 유도합니다. 댓글은 데뷔 전의 기대감이 현실로 인식되는 공간입니다.",
          strategy:
      ...
      subBlocks: [
        {
          ...
          strategy:
            "팬들에게 할 거리를 제공하는 맞춤형 ECADER 웹 경험(인터랙티브 콘셉트 사이트 또는 가벼운 웹 게임)을 구축하고, 참여 시점에 전화번호와 이메일을 확보한다. 수집한 데이터를 Laylo 방식의 CRM으로 연결해, 11월 싱글이 나올 무렵 ECADER가 관심을 빌리는 대신 자체 보유 리스트에 직접 문자를 보낼 수 있도록 한다. 이는 그렇지 않으면 예산이 놓치게 될 장기적 비즈니스 구축 자산이다.",
          components: {
            heading: "제공 결과물",
            items: [
    ...
    // ===================================================================
    {
      ...
      title: "투자",
      intro:
        "2026년 데뷔 전 기간(7월부터 9월까지)을 위한 단일 통합 워킹 미디어 예산은 $50,000이다. CCD 캠페인 리테이너와 15% 미디어 운용 수수료는 워킹 예산 위에 별도로 청구되며, 미디어 예산에서 차감되지 않는다. $50,000 전액이 워킹 미디어에 투입된다. 11월 싱글과 공식 데뷔는 각각 동일한 구조로 새로운 예산을 승인한다.",
      tiers: [
        {
          label: "데뷔 전 기간 (7월~9월)",
          budget: "$50,000",
          name: "워킹 미디어 예산",
          tagline:
            "데뷔 전 기간을 위한 통합 워킹 미디어. CCD 수수료(정액 리테이너 $5,000와 15% 미디어 운용 $7,500)는 그 위에 별도로 청구된다. 총 프로그램: $62,500.",
          featured: true,
          deployable: "$50,000",
          feeBreakdown: {
            retainer: "$5,000",
      ...
      footnote:
        "워킹 미디어는 $50,000이며 전액 투입된다. CCD 수수료 $12,500(정액 리테이너 $5,000와 15% 미디어 운용 $7,500)는 그 위에 별도로 청구되어 총 프로그램은 $62,500이다. 경험형 추가 항목은 별도로 산정 및 승인된다. 향후 각 사이클(11월 싱글, 데뷔, 첫 컴백)은 이 구조에 따라 개별적으로 예산을 승인받는다.",
    },
  ],
};
