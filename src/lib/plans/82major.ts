      ...
      tiers: [
        {
          ...
          feeBreakdown: {
            ...
            mediaManagement: "~$3,500",
            mediaManagementDetail: "15% on ~$22.5K managed",
          },
          breakdown: [
            { vertical: "US HQ-Style Fan Pages", amount: "$12,000" },
            { vertical: "Paid Social (IG + TikTok + X)", amount: "$22,500" },
            { vertical: "Strive.fm", amount: "$4,500" },
            { vertical: "CCD Retainer + Mgmt Fee", amount: "$11,000" },
          ],
        },
        {
          label: "Tier 02",
          ...
          feeBreakdown: {
            ...
            mediaManagementDetail: "15% on ~$42K managed",
          },
          breakdown: [
            { vertical: "US HQ-Style Fan Pages", amount: "$12,000" },
            ...
            { vertical: "Spotify Playlisting", amount: "$10,000" },
            { vertical: "Strive.fm", amount: "$4,500" },
            { vertical: "YouTube Advertising", amount: "$5,000" },
            { vertical: "Experiential / OOH", amount: "$10,000" },
            { vertical: "CCD Retainer + Mgmt Fee", amount: "$13,500" },
          ],
        },
      ],
      addOns: [
