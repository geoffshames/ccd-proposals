  ...
  sections: [
    ...
    // ===================================================================
    {
      ...
      weeks: [
        ...
        { index: 7, label: "W7", dates: "Jul 20", highlight: true, note: "RELEASE (TBD)" },
      ...
      weekBreakdowns: [
        { weekIndex: 1, title: "CRM + Paid Social kickoff", items: ["Stand up Laylo for Email + SMS. Import existing fan contacts. Build welcome flow and first broadcast template.",
          "Light Paid Social warm-up: 2 to 3 evergreen creative tests against U.S. lookalikes and interest stacks to baseline CPV and CPM.",
          "Brief U.S. HQ fan page operators. Confirm content cadence, source assets, posting plan."] },
        { weekIndex: 2, title: "U.S. HQ Fan Pages launch", items: ["Fan pages go live on IG + TikTok with launch posts. Target cadence: 5x per week IG, 7x per week TikTok per page.",
          "Paid Social continues evergreen testing. First round of creative learnings logged and applied.",
          "Laylo: first scheduled broadcast (introduction + fan rally CTA)."] },
        { weekIndex: 3, title: "Always-on build", items: ["Fan pages on launch cadence. First organic momentum readouts (saves, shares, comments per post).",
          "Paid Social: introduce 2 to 3 new variants based on W1-W2 winners. Begin retargeting pool seeding.",
          "Laylo: second broadcast (lyric or audio snippet from existing catalog to reward subscribers)."] },
        { weekIndex: 4, title: "Catalog activation", items: ["Fan pages lean into back-catalog clips + behind-the-scenes content to deepen retargeting pool.",
          "Paid Social: scale top-performing creative, refine audience stacks, prune underperformers.",
          "Laylo: third broadcast. Segmentation experiment (high-engagement vs new subscribers)."] },
        { weekIndex: 5, title: "Teaser wave 1 (illustrative)", items: ["Influencer seeding begins: 10 to 15 mid-tier U.S. creators receive SIGN Remix early access, brief, and assets.",
          "Paid Social pivots to teaser creative: snippets, MV teases, coming-soon angles.",
          "Fan pages amplify teaser drops; cadence ramps.",
          "Laylo: teaser flow built and queued."] },
        { weekIndex: 6, title: "Teaser wave 2 (illustrative)", items: ["Influencer warm-up continues; first wave of organic creator posts may land.",
          "Paid Social heavy on teaser creative through pre-save campaigns.",
          "Fan pages at peak teaser cadence with countdown content.",
          "Laylo: teaser flow goes live (timed Email broadcast + automated SMS reminder)."] },
        { weekIndex: 7, title: "Release window (TBD)", items: ["ASSUMING the SIGN Remix releases this week, full post-release push activates across all workstreams.",
          "Influencer scales to full deployment. Bulk of creator posts cluster around release.",
          "Paid Social at peak budget against release-day creative + post-save funnels.",
          "Laylo release-day flow: SMS blast + Email blast + segmented follow-ups.",
          "Fan pages at heavy cadence: MV cuts, reaction edits, share-bait posts."] },
        { weekIndex: 8, title: "Post-release week 2", items: ["Paid Social sustains heavy budget. Cycle in 2 to 3 new creative variants based on release-week winners.",
          "Influencer posts continue rolling out (wave 2 of seeded creators).",
          "Fan pages: reactions, chart performance content, fan UGC compilations.",
          "Laylo: post-release engagement broadcast (thank-you + next-step CTA)."] },
        { weekIndex: 9, title: "Post-release week 3", items: ["Paid Social maintains spend; layer in deeper retargeting pools (video viewers, IG profile visitors).",
          "Influencer wave winds down naturally; selectively boost top-performing posts.",
          "Fan pages shift to evergreen + remix/MV alt-cut content."] },
        { weekIndex: 10, title: "Post-release week 4", items: ["Paid Social: final heavy week. Pull underperforming creatives, double down on winners.",
          "Fan pages keep cadence on whatever is still pulling.",
