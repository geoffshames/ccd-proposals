...
export const eightyTwoMajorPlan: StrategyPlanData = {
  ...
  sections: [
      ...
      tiers: [
        {
          ...
          goal: "Establish foundational U.S. fan ecosystem and sustained engagement through the SIGN push.",
          includes: [
        ...
        },
        {
          ...
          goal: "Accelerate audience growth on the SIGN cycle, with the firepower to compound momentum into the September comeback.",
          featured: true,
          includes: [
    ...
    // ===================================================================
    {
      ...
      tiers: [
        {
          ...
          feeBreakdown: {
            ...
            mediaManagement: "~$3,000",
            mediaManagementDetail: "15% on ~$18K managed",
          },
          breakdown: [
            { vertical: "US HQ-Style Fan Pages", amount: "$14,500" },
            { vertical: "Paid Social (IG + TikTok + X)", amount: "$10,000" },
            { vertical: "Influencer", amount: "$3,000" },
            { vertical: "Clipping / Seeding", amount: "$4,000" },
            { vertical: "Strive.fm (capped at $1,500/mo)", amount: "$3,000" },
            { vertical: "YouTube Advertising", amount: "$5,000" },
            { vertical: "CCD Retainer + Mgmt Fee", amount: "$10,500" },
          ],
        },
        {
          label: "Tier 02",
          ...
          feeBreakdown: {
            ...
            mediaManagementDetail: "15% on ~$44K managed",
          },
          breakdown: [
            { vertical: "US HQ-Style Fan Pages (Expanded)", amount: "$22,000" },
            { vertical: "Paid Social (IG + TikTok + X)", amount: "$22,000" },
            { vertical: "Influencer", amount: "$12,000" },
            { vertical: "Clipping / Seeding", amount: "$8,000" },
            { vertical: "Spotify Playlisting", amount: "$7,500" },
            { vertical: "Strive.fm (capped at $1,500/mo)", amount: "$4,500" },
            { vertical: "YouTube Advertising", amount: "$10,000" },
      ...
      footnote: "Each release cycle gets its own tier authorization. The September comeback triggers Cycle 2 (same structure, new budget call based on Cycle 1 performance). Add-ons trigger per release cycle on standalone SOW.",
    },
  ],
};
