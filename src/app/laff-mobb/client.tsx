    ...
    <main className="relative">
      ...
      <section id="audience" className="px-5 py-24 md:px-10 md:py-32">
        <div className="mx-auto max-w-[1200px]">
          <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
            <div>
              <SectionHead
                code="05"
                label="The audience"
                title={<>The <span className="text-accent">17-to-24</span> tribe that moves culture.</>}
                lede="We are built for the audience that decides what is funny. The core is 17 to 24: high school seniors, college students, and early-career Gen Z in the US. The secondary is 25 to 34, the younger millennials who came up on 2000s comedy and never left. They are mobile-first, culturally fluent, and allergic to anything that smells like an ad. Memes beat billboards, a creator beats a TV spot, and a friend's story beats them both."
              />
              <div className="flex flex-wrap gap-2.5">
                {[
                  "Primary: 17 to 24, US",
          ...
          {/* DEMOGRAPHIC + PSYCHOGRAPHIC PANELS */}
          <div className="mt-14 grid gap-5 lg:grid-cols-2">
            <ScrollReveal variant="fadeUp">
              <div className="ccd-card h-full rounded-lg p-7">
                <div className="font-mono text-[11px] uppercase tracking-[0.18em] text-accent">Demographics</div>
                <h3 className="mt-3 text-xl">Who they are</h3>
                <dl className="mt-5 divide-y divide-border">
                  {[
                    ["Primary age", "17 to 24 (US Gen Z)"],
                    ["Secondary age", "25 to 34 (younger millennials)"],
                    ["Gender", "Roughly 60% male, 40% female"],
                    ["Life stage", "High school, college, early career"],
                    ["Geography", "50+ college markets and major US metros"],
                    ["Behavior", "High nightlife participation, always-on mobile"],
                  ].map(([k, v]) => (
                    <div key={k} className="flex items-baseline justify-between gap-6 py-3">
                      <dt className="font-mono text-[11px] uppercase tracking-[0.1em] text-text-muted">{k}</dt>
                      <dd className="text-right text-[14px] text-text-primary">{v}</dd>
                    </div>
                  ))}
                </dl>
              </div>
            ...
            <ScrollReveal variant="fadeUp">
              <div className="ccd-card h-full rounded-lg p-7">
                <div className="font-mono text-[11px] uppercase tracking-[0.18em] text-accent">Psychographics</div>
                <h3 className="mt-3 text-xl">What makes them move</h3>
                <ul className="mt-5 space-y-3.5">
                  {[
                    [
                      "Authenticity over polish",
                      "They reward humor and honesty and tune out anything that feels corporate or scripted.",
                    ],
                    [
                      "Belonging, not following",
                      "They join tribes and inside jokes. They do not follow ads, they follow people.",
                    ],
                    [
                      "Discovery is social",
                      "Culture reaches them through phones, memes, and creators, not commercial breaks.",
                    ],
                    ["Trust runs peer to peer", "A creator's word outweighs a brand's, and a friend's outweighs both."],
                    [
                      "Built to share",
                      "They live for shareable moments and stories worth retelling the next morning.",
                    ],
                  ].map(([k, v]) => (
                    <li key={k} className="flex gap-3">
                      <span className="mt-1 font-mono text-[13px] text-accent">//</span>
          ...
          {/* DATA BAND */}
          <div className="mt-5 rounded-lg border border-border bg-bg-card p-7 md:p-9">
            <div className="grid grid-cols-2 gap-x-6 gap-y-8 md:grid-cols-4">
              {[
                { v: "46%", l: "of US teens are online almost constantly" },
                { v: "90%", l: "of US teens are on YouTube; about 60% on TikTok and Instagram" },
                { v: "87%", l: "of Gen Z will buy on a creator's word, vs 54% of boomers" },
                { v: "+$9T", l: "in new Gen Z global spending by 2034, more than any generation" },
              ].map((s) => (
                <ScrollReveal key={s.l} variant="fadeUp">
                  <div className="border-l-2 border-accent pl-4">
                    <div className="display text-[clamp(1.8rem,3.4vw,2.6rem)] text-text-primary">{s.v}</div>
                    <div className="mt-2 text-[12px] leading-snug text-text-muted">{s.l}</div>
                  </div>
                </ScrollReveal>
              ))}
            </div>
            <p className="mt-7 font-mono text-[10px] uppercase tracking-[0.14em] text-text-muted">
              Sources: Pew Research Center 2024 · NielsenIQ × World Data Lab Spend Z · Clutch
            </p>
          </div>
        </div>
      </section>
