...
function DecisionDock() {
  ...
  useEffect(() => {
    ...
    // A rootMargin band above the footer gives the observer lead distance;
    // combined with the instant visibility switch, the dock is gone before
    // the footer can reach the viewport.
