...
import { marqueeWords } from "@/lib/champion-teamwear-ideas";
    ...
    <header id="top" ref={ref} className={styles.heroScroll}>
      <div className={styles.heroSticky}>
        ...
        <div className={styles.heroBase}>
          ...
          <a className={styles.heroCue} href="#premise">
            Scroll to enter <ArrowDown />
          </a>
          <span>Strategy document / September 2026</span>
        </div>
      </div>
    </header>
  );
...
const phraseParts = marqueeWords;
...
export function KineticRosterBand() {
  ...
  return (
    <div
      ...
      aria-label="Coach, athletic director, booster club, parent and athlete: one decision"
    >
      <motion.div
